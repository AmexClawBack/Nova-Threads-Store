...
function VisionGui(props) {
  const $ = c(199), {
    ...
    perspectiveStack
  } = usePerspective(), editorQueryRef = useRef(null), editorParamsRef = useRef(null), visionRootRef = useRef(null), customApiVersionElementRef = useRef(null), querySubscriptionRef = useRef(void 0), listenSubscriptionRef = useRef(void 0);
  let t0;
  $[0] !== projectId ? (t0 = () => getLocalStorage(projectId || "default"), $[0] = projectId, $[1] = t0) : t0 = $[1];
  const [localStorage2] = useState(t0);
  let t1;
  ...
  const [dataset, setDataset] = useState(t6);
  let t7;
  ...
  }), t33 = [handleKeyDown, handlePaste], $[97] = handleKeyDown, $[98] = handlePaste, $[99] = t32, $[100] = t33) : (t32 = $[99], t33 = $[100]), useEffect(t32, t33);
  let t34, t35;
  $[101] === Symbol.for("react.memo_cache_sentinel") ? (t34 = () => () => {
    cancelQuerySubscription(), cancelListenerSubscription();
  }, t35 = [cancelQuerySubscription, cancelListenerSubscription], $[101] = t34, $[102] = t35) : (t34 = $[101], t35 = $[102]), useEffect(t34, t35);
  let t36;
  $[103] !== setPerspective ? (t36 = (stack) => {
    stack.length > 0 && setPerspective("pinnedRelease");
  }, $[103] = setPerspective, $[104] = t36) : t36 = $[104];
  const handleStudioPerspectiveChange = useEffectEvent(t36);
  let t37;
  ...
  let t38;
  $[108] !== perspectiveStack ? (t38 = [perspectiveStack], $[108] = perspectiveStack, $[109] = t38) : t38 = $[109], useEffect(t37, t38);
  let t39;
  ...
  let t49;
  $[128] !== t48 ? (t49 = /* @__PURE__ */ jsx(InputBackgroundContainerLeft, { children: /* @__PURE__ */ jsx(Flex, { children: /* @__PURE__ */ jsx(StyledLabel, { muted: !0, children: t48 }) }) }), $[128] = t48, $[129] = t49) : t49 = $[129];
  let t50;
  $[130] !== query ? (t50 = /* @__PURE__ */ jsx(VisionCodeMirror, { initialValue: query, onChange: setQuery, ref: editorQueryRef }), $[130] = query, $[131] = t50) : t50 = $[131];
  let t51;
  $[132] !== t49 || $[133] !== t50 ? (t51 = /* @__PURE__ */ jsx(InputContainer, { display: "flex", "data-testid": "vision-query-editor", children: /* @__PURE__ */ jsxs(Box, { flex: 1, children: [
    t49,
    t50
  ] }) }), $[132] = t49, $[133] = t50, $[134] = t51) : t51 = $[134];
  let t52;
  $[135] !== handleParamsChange || $[136] !== params.error || $[137] !== params.raw || $[138] !== params.valid ? (t52 = /* @__PURE__ */ jsx(ParamsEditor, { value: params.raw, onChange: handleParamsChange, paramsError: params.error, hasValidParams: params.valid, editorRef: editorParamsRef }), $[135] = handleParamsChange, $[136] = params.error, $[137] = params.raw, $[138] = params.valid, $[139] = t52) : t52 = $[139];
  let t53;
  $[140] !== handleListenExecution || $[141] !== handleQueryExecution || $[142] !== listenInProgress || $[143] !== params.valid || $[144] !== queryInProgress ? (t53 = /* @__PURE__ */ jsx(VisionGuiControls, { hasValidParams: params.valid, queryInProgress, listenInProgress, onQueryExecution: handleQueryExecution, onListenExecution: handleListenExecution }), $[140] = handleListenExecution, $[141] = handleQueryExecution, $[142] = listenInProgress, $[143] = params.valid, $[144] = queryInProgress, $[145] = t53) : t53 = $[145];
  let t54;
  $[146] !== t52 || $[147] !== t53 ? (t54 = /* @__PURE__ */ jsxs(InputContainer, { display: "flex", children: [
    t52,
    t53
  ...
  let t56;
  $[157] !== dataset || $[158] !== e2eTime || $[159] !== error || $[160] !== listenInProgress || $[161] !== listenMutations || $[162] !== queryInProgress || $[163] !== queryResult || $[164] !== queryTime ? (t56 = /* @__PURE__ */ jsx(VisionGuiResult, { error, queryInProgress, queryResult, listenInProgress, listenMutations, dataset, queryTime, e2eTime }), $[157] = dataset, $[158] = e2eTime, $[159] = error, $[160] = listenInProgress, $[161] = listenMutations, $[162] = queryInProgress, $[163] = queryResult, $[164] = queryTime, $[165] = t56) : t56 = $[165];
  let t57;
  $[166] !== t42 || $[167] !== t55 || $[168] !== t56 ? (t57 = /* @__PURE__ */ jsx(Box, { height: "stretch", flex: 1, children: /* @__PURE__ */ jsxs(SplitPane, { className: "sidebarPanes", split: t42, minSize: 300, children: [
    t55,
    t56
  ...
  let t62;
  $[175] !== isQueryRecallCollapsed ? (t62 = /* @__PURE__ */ jsx("div", { style: t61, children: isQueryRecallCollapsed ? /* @__PURE__ */ jsx(ChevronLeftIcon, {}) : /* @__PURE__ */ jsx(ChevronRightIcon, {}) }), $[175] = isQueryRecallCollapsed, $[176] = t62) : t62 = $[176];
  let t63;
  $[177] !== t60 || $[178] !== t62 ? (t63 = /* @__PURE__ */ jsx(Button, { mode: "ghost", padding: 2, style: t59, onClick: t60, children: t62 }), $[177] = t60, $[178] = t62, $[179] = t63) : t63 = $[179];
  let t64;
  $[180] !== params.parsed ? (t64 = params.parsed || {}, $[180] = params.parsed, $[181] = t64) : t64 = $[181];
  let t65;
  $[182] !== generateUrl || $[183] !== getStateFromUrl || $[184] !== query || $[185] !== setStateFromParsedUrl || $[186] !== t64 || $[187] !== url ? (t65 = /* @__PURE__ */ jsx(QueryRecall, { url, getStateFromUrl, setStateFromParsedUrl, currentQuery: query, currentParams: t64, generateUrl }), $[182] = generateUrl, $[183] = getStateFromUrl, $[184] = query, $[185] = setStateFromParsedUrl, $[186] = t64, $[187] = url, $[188] = t65) : t65 = $[188];
  let t66;
  $[189] !== t63 || $[190] !== t65 ? (t66 = /* @__PURE__ */ jsxs(Box, { style: t58, children: [
    t63,
    t65
  ] }), $[189] = t63, $[190] = t65, $[191] = t66) : t66 = $[191];
  let t67;
  $[192] !== t41 || $[193] !== t57 || $[194] !== t66 ? (t67 = /* @__PURE__ */ jsx(SplitpaneContainer, { flex: "auto", children: /* @__PURE__ */ jsxs(SplitPane, { minSize: 800, defaultSize: window.innerWidth - 275, size: t41, maxSize: -225, primary: "first", children: [
    t57,
    t66
  ] }) }), $[192] = t41, $[193] = t57, $[194] = t66, $[195] = t67) : t67 = $[195];
  let t68;
  return $[196] !== t40 || $[197] !== t67 ? (t68 = /* @__PURE__ */ jsxs(Root, { direction: "column", height: "fill", ref: visionRootRef, sizing: "border", overflow: "hidden", "data-testid": "vision-root", children: [
    t40,
    t67
